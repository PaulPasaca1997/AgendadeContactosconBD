...
public class ControladorBaseDatosGUI extends javax.swing.JFrame {
    ...
    public ControladorBaseDatosGUI() {
        initComponents();
  ...
  int i=0;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControladorBaseDatosGUI().setVisible(true);
            }
        });
    }
    ...
    public void cargarDriver(){
        ...
        try {
            ...
            conexion = DriverManager.getConnection(urlbd, "String","String");
